...
@Singleton
@CompileStatic
class ExcelDataModelExporter implements DataModelExporterPlugin {
    ...
    final String displayName = 'Excel (XLSX) Exporter'
    ...
    byte[] exportModels(Collection<DataModel> models) {
        ...
        try (final XSSFWorkbook workbook = Utils.loadTemplateWorkbook(DATAMODELS_TEMPLATE_FILENAME)) {

            Utils.loadDataModelsIntoWorkbook(models, workbook)
